/*
    QUESTION 2: what skills are reduired for the top-paying data analyst jobs?
    - use the top 10 highest paying data analyst jobs from the forst query
...
/*
Insight:
SQL and Python are the top must-have skills for data analyst roles. 
Tableau is also in high demand for visualization. Snowflake, Excel,
and Pandas show the need for data handling skills. R, Go, 
and Bitbucket are less common but still useful.
